...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.projet.groupeidm.module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class moduleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFromationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_module_fromation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_module_fromation_feature",
								"_UI_module_type"),
						GroupeidmPackage.Literals.MODULE__FROMATION, true, false, true, null, null, null));
	}
	...
	protected void addAuteurPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_module_auteur_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_module_auteur_feature", "_UI_module_type"),
						GroupeidmPackage.Literals.MODULE__AUTEUR, true, false, true, null, null, null));
	}
	...
	protected void addTrackingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_module_tracking_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_module_tracking_feature",
								"_UI_module_type"),
						GroupeidmPackage.Literals.MODULE__TRACKING, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GroupeidmPackage.Literals.MODULE__CHAPITRE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(GroupeidmPackage.Literals.MODULE__CHAPITRE,
				GroupeidmFactory.eINSTANCE.createchapitre()));
	}
